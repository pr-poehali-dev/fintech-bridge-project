      ...
      <div className="p-6">
        <div className="flex items-center gap-3 mb-2">
          <svg className="w-12 h-12" viewBox="0 0 974.28 376.03">
            ...
            <path fill="#00adee" d="M577.28,152.58c-5.63,2.51-13.52,16.82-18.32,22.29-2.35,2.68-4.65,4.26-6.4,5.45-5.17,3.54-10.04,4.73-13.39,6.05-10.96,4.29-20.98,5.13-36.73,6.46-.54.05-4.73.29-13.14.79,0,0-13.1.77-30.53-.38-3.75-.25-8.01-.61-10.26-3.73-.91-1.27-1.99-3.71-1.34-6.46.51-2.21,1.92-3.59,2.5-4.11,7.79-5.18,15.6-10.35,23.39-15.53.2-1.54.54-3.84,1.27-6.6,1.45-5.67,4.44-13.31,10.67-20.5,7.7-8.86,16.38-12.5,19.1-13.54,10.04-3.84,18.83-3.25,23.07-2.67.56-.97,1.58-2.37,3.3-3.34,4.35-2.49,11.14-1.02,12.72,2.82.29.68.6,1.94.07,3.86,1.47.47,3.55,1.22,5.96,2.33,1.67.77,7.16,3.35,12.79,7.93,8.15,6.63,12.93,14.43,15.29,18.87Z"/>
            <path fill="#fff" d="M224.38,261.34c13.15-4.15,81.69-14.86,96.18-14.87,1.23,1.97,2.79,5,3.67,8.92.86,3.87.33,14.14-3.48,21.89-5.57,11.33-19.23,19.59-35.67,21.33-25.77,4.51-48.62-3.51-57.07-19.61-1.81-3.46-3.99-9.23-3.62-17.67Z"/>
            <path fill="#fff" d="M581.13,239.64c15.83,2.13,79.87,12.22,95.16,14.97-.03,1.23-.16,2.96-.66,4.95-3.92,15.72-24.81,25.26-41.21,26.67-17.45,1.51-34.49-5.8-43.9-16.78-2.25-2.63-7.17-8.37-9.04-17.43-1.05-5.11-.76-9.5-.35-12.38Z"/>
            <circle fill="#2e2e2e" cx="621.88" cy="266.02" r="14.8"/>
            <circle fill="#2e2e2e" cx="289.26" cy="273.77" r="14.8"/>
          </svg>
          <div>
